#!/usr/bin/env python3
"""
Fix Carousel HTML Display Issue
The carousel HTML is showing as raw text instead of rendered HTML
"""
...
# Clean carousel HTML without <p> tags and <br> elements
CLEAN_CAROUSEL_HTML = """<!-- Original Category Image Carousel - Fixed Display -->
<style>
...
def fix_carousel_display():
    """Fix the carousel HTML display issue by updating with clean HTML"""
    print("=" * 70)
    print("🔧 FIXING CAROUSEL HTML DISPLAY ISSUE")
    print("=" * 70)
    print()

    print("The carousel HTML is being displayed as raw text instead of rendered HTML.")
    print("This is likely due to WordPress auto-formatting the content.")
    print("-" * 70)
    ...
    response = requests.post(
        url,
        json={'content': CLEAN_CAROUSEL_HTML},
        auth=HTTPBasicAuth(WORDPRESS_USERNAME, WORDPRESS_PASSWORD)
    )

    if response.status_code == 200:
        print("✅ Carousel HTML display fixed!")
        print()
        print("What was fixed:")
        print("   ✅ Removed <p> tags wrapping HTML elements")
        print("   ✅ Removed <br /> tags from CSS and HTML")
        print("   ✅ Clean HTML structure for proper rendering")
        print("   ✅ Preserved all carousel functionality")
        print()
        print("=" * 70)
        print("✅ FIX COMPLETE!")
        print("=" * 70)
        ...
        print("  3. Verify carousel renders properly (not as raw text)")
        print("  4. Test auto-scrolling and hover effects")
        print()
        print("If still showing as text:")
        print("  • Check if homepage is set to static page")
        print("  • Try editing the page in WordPress HTML mode")
        print("  • Disable any auto-formatting plugins")
        print()
        return True
    else:
